...
class GetProductAllUseCase(schedulers: Schedulers, private val gateway: GiftShopGateway) :
    UseCaseFlowable<List<Product>, Void>(schedulers) {

    override fun buildUseCaseFlowable(params: Void?): Flowable<List<Product>> = gateway.getProductAll()
}